...
# ========================
# Tool Executor (Central Logic for All App Functions)
# ========================
class ToolExecutor:
    ...
    def execute(self, intent: str, params: dict, save_draft=True):
        ...
        if intent == "GENERATE_ARTICLE":
            ...
            3. A list of 3-5 relevant educational video links (e.g., from YouTube) with a title and the full URL.
        ...
        if intent == "FURTHER_READING":
            prompt = f"""
            Based on the following text, please suggest resources for further reading and viewing. The section must include:
            1. A list of 3-5 relevant book recommendations (Title by Author).
        ...
        if intent == "SUMMARIZE":
            ...
            return self.llm._call(params.get("prompt", "")), ""
...
# --- Tab 1: AI Chatbot (UPDATED WITH UX IMPROVEMENT) ---
with tabs[0]:
